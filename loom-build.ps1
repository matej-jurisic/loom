# Loom release-APK builder. One command: bump version -> build SPA -> cap sync -> sign -> assemble
...
$keystore = "D:\Projects\loom-release.jks"          # kept OUTSIDE the repo
$alias    = "loom"
$clientDir = "D:\Projects\loom\client"
$projDir   = "D:\Projects\loom\client\android"
$gradle    = "$projDir\app\build.gradle"
$outDir    = "D:\Projects\loom\release"              # staged APKs
...
if (-not (Test-Path $keystore)) {
    ...
    & "$jbr\bin\keytool.exe" -genkeypair -v -keystore $keystore -alias $alias `
        -keyalg RSA -keysize 2048 -validity 10000 -storepass $pass -keypass $pass -dname "CN=Loom"
} else {
...
$env:JAVA_HOME               = $jbr
$env:LOOM_KEYSTORE           = $keystore
$env:LOOM_KEYSTORE_PASSWORD  = $pass
$env:LOOM_KEY_ALIAS          = $alias
$env:LOOM_KEY_PASSWORD       = $pass
