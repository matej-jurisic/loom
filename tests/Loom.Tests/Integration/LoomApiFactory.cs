...
public class LoomApiFactory : WebApplicationFactory<Program>, IDisposable
{
    internal const string TestJwtSecret = "integration-test-secret-key-32-chars-minimum";

    private readonly SqliteConnection _connection;

    public LoomApiFactory()
    {
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        {
            var descriptor = services.SingleOrDefault(d => d.ServiceType == typeof(DbContextOptions<LoomDbContext>));
            ...
            scope.ServiceProvider.GetRequiredService<LoomDbContext>().Database.EnsureCreated();
        });
    }
